    ...
    if printOne>0 or printTwo>0 or printThree>0 or printFour>0: #if statement
        ...
        def confirmOrder():
            ...
            if name=="" or emailt=="": #if one is blank
                ...
                file.write(text)
                messagebox.showinfo(title="Order",message="Order Placed Successfully!") #order placed successfully prompt
        ...
        messagebox.showerror(title="Error",message='Please select some pictures to place an order!')#Error message
